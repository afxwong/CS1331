...
public class BattleSim {
    ...
    public void addArtist() {
        ...
        if (type.equals("Singer")) {
            ...
            Singer s = new Singer(name, talent, range);
            band.addMembers(s);
            ...
            Guitarist g = new Guitarist(name, talent, sp);
            band.addMembers(g);
    ...
    public void battle() {
        ...
        double score1 = b1.perform();
        double score2 = b2.perform();

        String winner = "REPLACE WITH WINNER";

        //If the two bands' performance scores are the same, print out "It was a tie" instead
        if (score1 == score2) {
            winner = "It's a tie";
